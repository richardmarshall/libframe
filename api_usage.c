...
int main(int argc, char **argv) {
	...
	char *layer_4_segment = simple_tcp(sport, dport, flags, seq, payload, &layer_4_size);
	/* create layer 3 packet */
	char *layer_3_segment = simple_ip(src_ip, dst_ip, flags, layer_4_segment, layer_4_size, &layer_3_size);
